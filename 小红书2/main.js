    ...
    function s() {
        ...
        return function (f, I, C) {
            ...
            var b = function (r, S, N, Y) {
                ...
                // console.log(`===== 开始log了====`)
                if (window.islog && S && S[0] != 'Q' && S[1] != "implementation") {
                    try {
                        // console.log(S)
                        // window.logs += S + "\r\n"
                        // window.logs2 += JSON.stringify(S) + "\r\n"
                    } catch (e) { }
                }
            ...
            var l = function (S, N, Y, Z) {
                ...
                if (S && typeof S == 'string' && S.indexOf(";x4=1727033536336;" != -1)) {
                    window.islog = true
                    // console.log("发现base64,开始输出log=======11====");
                    // window.logs += S + "\r\n";
                }
