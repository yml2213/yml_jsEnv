        ...
        return function(f, I, C) {
            ...
            var z = function(S) {
                ...
                var Y = function(o8) {
                    ...
                    var oB = o8.length
                    var oA = 0
                    for (var oA = 0; oA < oB; oA++) {
                        var os = o8.charCodeAt(oA)
                        if ((os >> 7 & 255) == 0) {
                            oo.push(o8.charAt(oA))
                        } else {
                            if ((os >> 5 & 255) == 6) {
                                var oc = o8.charCodeAt(++oA)
                                var oG = (os & 31) << 6
                                var oa = oc & 63
                                var oK = oG | oa
                                oo.push(String.fromCharCode(oK))
                            } else {
                                if ((os >> 4 & 255) == 14) {
                                    var oc = o8.charCodeAt(++oA)
                                    var of = o8.charCodeAt(++oA)
                                    var oG = os << 4 | oc >> 2 & 15
                                    var oa = (oc & 3) << 6 | of & 63
                                    var oK = (oG & 255) << 8 | oa
                                    oo.push(String.fromCharCode(oK))
                ...
                var o0 = []
                while (M < X) {
                    var o1 = Z.indexOf(S.charAt(M++))
                    var o2 = Z.indexOf(S.charAt(M++))
                    var o3 = Z.indexOf(S.charAt(M++))
                    var o4 = Z.indexOf(S.charAt(M++))
                    var o5 = o1 << 2 | o2 >> 4
                    var o6 = (o2 & 15) << 4 | o3 >> 2
                    var o7 = (o3 & 3) << 6 | o4
                    o0.push(String.fromCharCode(o5))
                    if (o3 != 64) {
                        o0.push(String.fromCharCode(o6))
                    }
                    if (o4 != 64) {
                        o0.push(String.fromCharCode(o7))
                    }
                }
                return Y(o0.join(""))
            }
            var b = function(r, S, N, Y) {
                // console.log("S:::===>  ", S, "类型===> ", typeof S)
                if (typeof S == "String" && S && S[0] != "Q") {
                    window.yml_ += ("S::" + S + "\r\n");
                } else if (S && typeof S == 'object' && S && S[0] != "Q" && S.toString() != '[object Window]') {
                    window.yml_ += ("S::" + S + "\r\n");
                }
                if (S && typeof S == "String" && S.indexOf("eDE9OTIyMDkwNTcyMzM5YjJhYjBjYTZhYTVmMDdmMTc4YmU7eDI9MHwwfDB8MXwwfDB8MXwwfDB8MHwxfDB8MHwwfDB8MXwwfDB8MDt4Mz0xOTIyNTdjZDM0MXIycWJ1Y2Q3amQzdXM0a2FsY21jNHNmN2M3MDlqeDMwMDAwMjAyMjE3O3g0PTE3MjcwMzM1MzYzMzY7" != -1)) {
            ...
            var D = function(r) {
                return r._garp_13b78 ? r._garp_1b7c6[r._garp_96ad3] : r._garp_d3087
            }
            var T = function(r, S) {
                return S.hasOwnProperty(r) ? K : a
            }
            var j = function(r, S) {
                if (T(r, S)) {
                    return b(c, S, r, G)
            ...
            var g = [b(c, c, c, c), b(c, c, c, c), b(c, c, c, c), b(c, c, c, c), b(c, c, c, c)]
            var x = [C, function r(S) {
                return g[S]
            }
            , function(S) {
                return b(c, P._garp_89216, S, G)
            }
            , function(S) {
                return U(S)
            }
            ...
            , function(S) {
                return b(P._garp_ab9e, c, c, c)
            }
            , function(S) {
                return b(c, I.d, S, G)
            }
            , function(S) {
                return b(P._garp_89216, C, C, c)
            }
            , function(S) {
                return b(c, H, S, c)
            }
            ...
            var u = function(S, N, Y, Z) {
                ...
                while (p < M) {
                    var o0 = Z[p]
                    var o1 = V[o0[c]]
                    p = o1(o0[1], o0[2], o0[3], o0[4], p, J, Z)
                }
                return p
            }
            var v = function(S, N) {
                var Z = R.splice(R.length - 6, 6)
                var X = Z[4]._garp_d3087 != 2147483647
                try {
                    S = u(Z[0], Z[1], S, N)
                } catch (p) {
                    console.log(p)
                ...
                return Z[5]._garp_d3087 > S ? Z[5]._garp_d3087 : S
            }
            var J = z(I.b).split("").reduce(function(S, N) {
                if (!S.length || S[S.length - G].length == 5) {
                    S.push([])
                }
                S[S.length - G].push(-G * 1 + N.charCodeAt())
                return S
            }, [])
            var V = [function(S, N, Y, Z, X, p, M) {
                ...
                var o4 = R.splice(R.length - o3, o3).map(D)
                var o5 = R.pop()
                var o6 = D(o5)
                o4.unshift(null)
                l(new (Function.prototype.bind.apply(o6, o4))(), C, C, 0)
                return ++X
            }
            ...
            , function(S, N, Y, Z, X, p, M) {
                var o1 = F(S, N)
                var o2 = O(S, N) - 1
                o1._garp_1b7c6[o1._garp_96ad3] = o2
                l(o2, C, C, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
            ...
            , function(S, N, Y, Z, X, p, M) {
                l(O(S, N) ^ O(Y, Z), C, C, 0)
                // console.log(O(S, N), "^", O(Y, Z), "======>", O(S, N) ^ O(Y, Z))
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                return ++X
            ...
            , function(S, N, Y, Z, X, p, M) {
                ...
                var o1 = O(S, N)
                l(o1++, C, C, 0)
                o0._garp_1b7c6[o0._garp_96ad3] = o1
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                l(O(S, N) !== O(Y, Z), C, C, 0)
            ...
            , function(S, N, Y, Z, X, p, M) {
                ...
                var o1 = R.splice(R.length - o0, o0).map(D)
                var o2 = R.pop()
                var o3 = D(o2)
                let this_ = typeof o2._garp_1b7c6 == "undefined" ? f : o2._garp_1b7c6
                // console.log("function::", o3, "this::", this_, "arguments::", o1)
                l(o3.apply(typeof o2._garp_1b7c6 == "undefined" ? f : o2._garp_1b7c6, o1), C, C, 0)
            ...
            , function(S, N, Y, Z, X, p, M) {
                l(O(S, N)instanceof O(Y, Z), C, C, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                l(-O(S, N), C, C, 0)
            ...
            , function(S, N, Y, Z, X, p, M) {
                return !D(g[0]) ? O(S, N) : ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                g[3] = b(R.length, 0, 0, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                l(O(S, N), C, C, 0)
            ...
            , function(S, N, Y, Z, X, p, M) {
                var o0 = F(S, N)
                l(delete o0._garp_1b7c6[o0._garp_96ad3], C, C, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                var o0 = O(S, N)
                l(R.splice(R.length - o0, o0).map(D), C, C, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                g[4] = L[L.length - 1]
            ...
            , function(S, N, Y, Z, X, p, M) {// debugger return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                l(O(S, N) < O(Y, Z), C, C, 0)
                return ++X
            ...
            , function(S, N, Y, Z, X, p, M) {
                var o0 = F(S, N)
                var o1 = O(Y, Z)
                l(o0._garp_1b7c6[o0._garp_96ad3] = o1, C, C, 0)
                return ++X
            }
            , function(S, N, Y, Z, X, p, M) {
                d(null)
...
let res = window._webmsxyw(c_data, i_data)
console.log(res)
let res1 = "XYW_"
console.log(res['X-s'])
console.log(res['X-s'] == res1)
