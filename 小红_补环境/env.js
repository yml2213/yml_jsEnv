...
WebGLDebugRenderInfo = function WebGLDebugRenderInfo() {
};
window.func_set_native(WebGLDebugRenderInfo);
WebGLDebugRenderInfo.prototype.UNMASKED_VENDOR_WEBGL = 37445
WebGLDebugRenderInfo.prototype.UNMASKED_RENDERER_WEBGL = 37446
...
document = {
    ...
    cookie: 'abRequestId=7f624ead-39b2-5847-a581-4be1a51aa1cb; xsecappid=xhs-pc-web; a1=19106c24c90uq4kbvzglto38naaecznf3yk1slnre50000220941; webId=157de2aa6e87230da94b79b6379a58d0; gid=yjy8KSJ2JJqYyjy8KSJ4Sv1Ij87A4TDhuk19TFdlqYI00y28dSuIiM888JJ8j4y82iY8WqKK; webBuild=4.35.0; unread={%22ub%22:%2266e39d70000000002700538a%22%2C%22ue%22:%2266dfcc50000000000c018c11%22%2C%22uc%22:25}; websectiga=3fff3a6f9f07284b62c0f2ebf91a3b10193175c06e4f71492b60e056edcdebb2; sec_poison_id=7ec97bb9-5020-4563-bb7f-7af141474f2a',
    referrer: '',
    visibilityState: 'visible',
};

HTMLAnchorElement = function HTMLAnchorElement(tag_name) {
    console.log(tag_name)
};
...
window.func_set_native(HTMLBodyElement);

HTMLHtmlElement = function HTMLHtmlElement() {
    this.getAttribute = function getAttribute() {
        console.log(arguments)
    };
    window.func_set_native(this.getAttribute);
};
window.func_set_native(HTMLHtmlElement);
...
document.documentElement = get_proxy(document.documentElement)
...
// =======================  navigator ============================================
navigator = {
    language: 'zh-CN', appName: "Netscape", appCodeName: "Mozilla",
};
...
function get_proxy(obj) {
    return new Proxy(obj, {
        get: function (target, p, receiver) {
            if (p !== 'Math' && p !== 'isNaN' && p !== 'undefined') {
                console.table([{
                    "method": "get", target: target, p: p, receiver: receiver, value: Reflect.get(target, p, receiver)
                }]);
